...
public class BlockRayTrace extends RayTrace<BlockSwingResult> {
    ...
    public BlockSwingResult run(Entity entity) {
        RayTraceResult result = Objects.requireNonNull(Minecraft.getInstance().world).rayTraceBlocks(start.getMinecraftVector(), end.getMinecraftVector(), profile.getFluidHandling());
