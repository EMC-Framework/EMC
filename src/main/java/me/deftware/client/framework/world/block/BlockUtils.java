...
public class BlockUtils {
    ...
    public static EnumFacing getBlockFacing(BlockPosition position) {
        IBlockState state = Minecraft.getMinecraft().theWorld.getBlockState((BlockPos) position);
        if (state.getBlock() instanceof BlockChest) {
    ...
    public static boolean isChest(BlockPos pos) {
        return Minecraft.getMinecraft().theWorld.getBlockState(pos).getBlock() instanceof BlockChest;
    }
