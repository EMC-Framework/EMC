...
public class ItemRenderer {
	...
	public void renderItemOverlays(ItemStack itemStack, int x, int y) {
		getRenderItem().renderItemOverlays(Minecraft.getMinecraft().fontRendererObj, (net.minecraft.item.ItemStack) itemStack, x, y);
	}
	...
	public void renderItemOverlayIntoGUI(ItemStack itemStack, int x, int y, String text) {
		getRenderItem().renderItemOverlayIntoGUI(Minecraft.getMinecraft().fontRendererObj, (net.minecraft.item.ItemStack) itemStack, x, y, text);
	}
