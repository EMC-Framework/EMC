...
public class ItemRendering {
	...
	public void drawItemStack(GLX context, ItemStack stack, int x, int y, int z) {
		render(context, z, matrices -> getRenderItem().renderInGui(matrices, (net.minecraft.item.ItemStack) stack, x, y));
	}
	...
	public void drawStackLabel(GLX context, ItemStack stack, int x, int y, int z, String count) {
		render(context, z, ctx ->
				getRenderItem().renderGuiItemOverlay(ctx, MinecraftClient.getInstance().textRenderer,
	...
	private void render(GLX ctx, int zOffset, Consumer<MatrixStack> runnable) {
