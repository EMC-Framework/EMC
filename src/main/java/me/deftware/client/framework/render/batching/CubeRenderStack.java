...
public class CubeRenderStack extends RenderStack<CubeRenderStack> {
	...
	public CubeRenderStack draw(BoundingBox box) {
		if (box == null)
			return this;
		AxisAlignedBB minecraftBox = (AxisAlignedBB) box.offset(-Minecraft.getMinecraftGame().getCamera()._getRenderPosX(), -Minecraft.getMinecraftGame().getCamera()._getRenderPosY(), -Minecraft.getMinecraftGame().getCamera()._getRenderPosZ());
		if (lines)
