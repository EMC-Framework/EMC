...
public class EntityFishHook extends Entity {
	...
	public static boolean hasFish() {
		return Objects.requireNonNull(Minecraft.getInstance().player).fishEntity != null;
	}

	public static EntityFishHook getInstance() {
		if (fishHook == null || Objects.requireNonNull(Minecraft.getInstance().player).fishEntity != fishHookPtr) {
			fishHookPtr = Objects.requireNonNull(Minecraft.getInstance().player).fishEntity;
