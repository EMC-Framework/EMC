...
public abstract class GuiScreen extends Screen implements GenericScreen {
	...
	public interface BackgroundType {
		 ...
		 */
		BackgroundType Textured = (context, mouseX, mouseY, delta, parent) -> parent.renderBackgroundTexture(context.getMatrices());
		 ...
		 */
		BackgroundType TexturedOrTransparent = (context, mouseX, mouseY, delta, parent) -> parent.renderBackground(context.getMatrices());
