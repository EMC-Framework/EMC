...
public class EntityFishHook extends Entity {
	...
	public static boolean hasFish() {
		return Objects.requireNonNull(Minecraft.getMinecraft().thePlayer).fishEntity != null;
	}

	public static EntityFishHook getInstance() {
		if (fishHook == null || Objects.requireNonNull(Minecraft.getMinecraft().thePlayer).fishEntity != fishHookPtr) {
			fishHookPtr = Objects.requireNonNull(Minecraft.getMinecraft().thePlayer).fishEntity;
