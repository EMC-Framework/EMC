...
public class ScreenHelper {
	...
	public static boolean isChatOpen() {
		if (net.minecraft.client.Minecraft.getInstance().currentScreen != null) {
			return net.minecraft.client.Minecraft.getInstance().currentScreen instanceof GuiChat;
		}
		return false;
	}
	...
	public static boolean isContainerOpen() {
		if (net.minecraft.client.Minecraft.getInstance().currentScreen != null) {
			return net.minecraft.client.Minecraft.getInstance().currentScreen instanceof GuiContainer
					&& !(net.minecraft.client.Minecraft.getInstance().currentScreen instanceof GuiInventory);
		}
		return false;
	}
	...
	public static boolean isInventoryOpen() {
		if (net.minecraft.client.Minecraft.getInstance().currentScreen != null) {
			return net.minecraft.client.Minecraft.getInstance().currentScreen instanceof GuiContainer
					&& (net.minecraft.client.Minecraft.getInstance().currentScreen instanceof GuiInventory
					|| net.minecraft.client.Minecraft.getInstance().currentScreen instanceof GuiContainerCreative);
		}
		return false;
	}
