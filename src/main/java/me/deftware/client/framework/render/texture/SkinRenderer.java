    ...
    public static void bindSkinTexture(String name, String uuid) {
        ...
        if(loadedSkins.containsKey(name)) {
            if (loadedSkins.get(name).getLeft()) {
                net.minecraft.client.Minecraft.getInstance().getTextureManager().bindTexture(loadedSkins.get(name).getRight());
            } else {
                net.minecraft.client.Minecraft.getInstance().getTextureManager().bindTexture(DefaultSkinHelper.getTexture(profile.getId()));
            }
        } else {
            loadedSkins.put(name, new Pair<>(false, null));
            try {
                net.minecraft.client.Minecraft.getInstance().getSkinProvider().loadSkin(profile, (type, identifier, minecraftProfileTexture) -> {
