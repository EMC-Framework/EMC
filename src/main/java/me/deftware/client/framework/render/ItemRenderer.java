...
public class ItemRenderer {
	...
	public void renderItemIntoGUI(ItemStack itemStack, int x, int y) {
		getRenderItem().renderGuiItemIcon((net.minecraft.item.ItemStack) itemStack, x, y);
	}

	public void renderItemOverlays(ItemStack itemStack, int x, int y) {
		getRenderItem().renderGuiItemOverlay(MinecraftClient.getInstance().textRenderer, (net.minecraft.item.ItemStack) itemStack, x, y);
	}

	public void renderItemAndEffectIntoGUI(ItemStack itemStack, int x, int y) {
		getRenderItem().renderGuiItem((net.minecraft.item.ItemStack) itemStack, x, y);
	}

	public void renderItemOverlayIntoGUI(ItemStack itemStack, int x, int y, String text) {
		getRenderItem().renderGuiItemOverlay(MinecraftClient.getInstance().textRenderer, (net.minecraft.item.ItemStack) itemStack, x, y, text);
	}
