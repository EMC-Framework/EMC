...
public class ItemRenderer {
	...
	private static net.minecraft.client.renderer.ItemRenderer getRenderItem() {
	...
	public void renderItemOverlays(ItemStack itemStack, int x, int y) {
		getRenderItem().renderItemOverlays(Minecraft.getInstance().fontRenderer, (net.minecraft.item.ItemStack) itemStack, x, y);
	}
	...
	public void renderItemOverlayIntoGUI(ItemStack itemStack, int x, int y, String text) {
		getRenderItem().renderItemOverlayIntoGUI(Minecraft.getInstance().fontRenderer, (net.minecraft.item.ItemStack) itemStack, x, y, text);
	}
