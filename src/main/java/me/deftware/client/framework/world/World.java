...
public class World {
	...
	public static long getWorldTime() {
		return Objects.requireNonNull(net.minecraft.client.Minecraft.getInstance().world).getTime();
	}

	public static void sendQuittingPacket() {
		Objects.requireNonNull(net.minecraft.client.Minecraft.getInstance().world).disconnect();
	}

	public static void leaveWorld() {
		net.minecraft.client.Minecraft.getInstance().joinWorld(null);
	}
	...
	public static void addEntityToWorld(int id, Entity entity) {
		Objects.requireNonNull(net.minecraft.client.Minecraft.getInstance().world).addEntity(id, entity.getMinecraftEntity());
	}

	public static void removeEntityFromWorld(int id) {
		Objects.requireNonNull(net.minecraft.client.Minecraft.getInstance().world).removeEntity(id);
	}
	...
	public static int getDimension() {
		return Objects.requireNonNull(net.minecraft.client.Minecraft.getInstance().player).world.getDimension().getType().getRawId();
	}
	...
	public static CompletableFuture<String> getUsernameFromUUID(UUID uuid) {
		return CompletableFuture.supplyAsync(() -> {
			...
			ClientPlayNetworkHandler networkHandler = net.minecraft.client.Minecraft.getInstance().getNetworkHandler();
