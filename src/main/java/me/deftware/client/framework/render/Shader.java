...
public class Shader {
    ...
    public void init(Minecraft client) {
        ...
        shaderEffect.createBindFramebuffers(client.mainWindow.getFramebufferWidth(), client.mainWindow.getFramebufferHeight());
        framebuffer = shaderEffect.getFramebufferRaw("final");
    }
