...
public class Minecraft {
	...
	public static MainEntityPlayer getPlayer() {
		...
		if (mainPlayer == null || mainPlayer.getMinecraftEntity() != player)
			mainPlayer = (MainEntityPlayer) World.getEntityById(player.getEntityId());
		return mainPlayer;
	}
	...
	public static Entity getCameraEntity() {
		...
		if (cameraEntity == null || cameraEntity.getMinecraftEntity() != entity)
			cameraEntity = World.getEntityById(entity.getEntityId());
		return cameraEntity;
	}
	...
	public static Entity getHitEntity() {
		if (MinecraftClient.getInstance().crosshairTarget instanceof EntityHitResult) {
			return World.getEntityById(
					((EntityHitResult) MinecraftClient.getInstance().crosshairTarget).getEntity().getEntityId()
			);
		}
		return null;
	}
