...
public class EntityPlayer extends LivingEntity {
	...
	public boolean isCreative() {
		return getMinecraftEntity().capabilities.isCreativeMode;
	}
	...
	public boolean isAtEdge() {
		return net.minecraft.client.Minecraft.getMinecraft().theWorld.getCollisionBoxes(getMinecraftEntity().getEntityBoundingBox().offset(0, -0.5, 0).expand(-0.001, 0, -0.001)).isEmpty();
	}
	...
	public int getItemInUseMaxCount() {
		return getMinecraftEntity().getHeldItem().getMaxItemUseDuration();
	}
