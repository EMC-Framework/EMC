...
public class BlockManagement {
    ...
    public static void shouldDrawSide(IBlockState state, IBlockReader world, BlockPos pos, EnumFacing facing, CallbackInfoReturnable<Boolean> callback) {
    ...
    public static boolean isAnySideTouchingBlock(BlockPos pos, IBlockReader world, Block... blocks) {
