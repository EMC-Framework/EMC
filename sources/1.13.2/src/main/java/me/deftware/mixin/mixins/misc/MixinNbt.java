...
public class MixinNbt implements me.deftware.client.framework.nbt.NbtCompound {
    ...
    public boolean contains(String key) {
        return ((NBTTagCompound) (Object) this).contains(key);
    }

    @Unique
    @Override
    public boolean contains(String key, int type) {
        return ((NBTTagCompound) (Object) this).contains(key, type);
    }

    @Unique
    @Override
    public me.deftware.client.framework.nbt.NbtCompound get(String key) {
        return (me.deftware.client.framework.nbt.NbtCompound) ((NBTTagCompound) (Object) this).get(key);
    }

    @Unique
    @Override
    public NbtList getList(String items, int type) {
        return (NbtList) ((NBTTagCompound) (Object) this).getList(items, type);
    }
    ...
    public void put(String key, NbtList list) {
        ((NBTTagCompound) (Object) this).put(key, (NBTTagList) list);
    }
