...
public class Minecraft {
	...
	private static final ComparedConversion<EntityPlayerSP, MainEntityPlayer> mainPlayer =
			new ComparedConversion<>(() -> net.minecraft.client.Minecraft.getMinecraft().thePlayer, MainEntityPlayer::new);
	...
	private static final ComparedConversion<net.minecraft.entity.Entity, Entity> hitEntity =
			new ComparedConversion<>(() -> {
				if (net.minecraft.client.Minecraft.getMinecraft().objectMouseOver != null) {
					if (net.minecraft.client.Minecraft.getMinecraft().objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.ENTITY) {
	...
	private static final ComparedConversion<MovingObjectPosition, BlockSwingResult> hitBlock =
			new ComparedConversion<>(() -> {
				if (net.minecraft.client.Minecraft.getMinecraft().objectMouseOver != null) {
					if (net.minecraft.client.Minecraft.getMinecraft().objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
