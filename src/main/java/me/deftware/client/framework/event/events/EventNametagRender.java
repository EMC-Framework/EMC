...
public class EventNametagRender extends Event {
    ...
    public EventNametagRender(Entity entity) {
        me.deftware.client.framework.entity.Entity emcEntity
                = Objects.requireNonNull(((IMixinWorldClient) net.minecraft.client.Minecraft.getMinecraft().world)).getLoadedEntitiesAccessor().getOrDefault(entity.getEntityId(), null);
        if (emcEntity != null) {
