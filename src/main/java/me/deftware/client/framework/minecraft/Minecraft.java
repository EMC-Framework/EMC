...
public interface Minecraft {
	...
	default MainEntityPlayer _getPlayer() {
		if (this.getClientWorld() == null)
			return null;
		return this.getClientWorld().getEntityByReference(net.minecraft.client.Minecraft.getMinecraft().player);
	}
	...
	default GameChat getGameChat() {
		return (GameChat) net.minecraft.client.Minecraft.getMinecraft().ingameGUI.getChatGUI();
	}
