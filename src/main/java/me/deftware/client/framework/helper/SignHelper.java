...
public class SignHelper {
	...
	public static ChatMessage getText(int line) {
		return new ChatMessage().fromText(Objects.requireNonNull((IMixinGuiEditSign) Minecraft.getMinecraft().currentScreen).getTileSign().signText[line], false);
	}

	public static void setText(String text, int line) {
		Objects.requireNonNull((IMixinGuiEditSign) net.minecraft.client.Minecraft.getMinecraft().currentScreen).getTileSign().signText[line] = new ChatComponentText(text);
	}
