...
public class SelectableList<T extends SelectableList.ListItem> extends GuiSlot implements Element, Tooltipable, GenericComponent {
	...
	protected void drawSlot(int slotIndex, int xPos, int yPos, int heightIn, int mouseXIn, int mouseYIn, float partialTicks) {
		...
		item.render(GLX.getInstance(), slotIndex, xPos, yPos, getListWidth(), heightIn, mouseXIn, mouseYIn, partialTicks);
		this.onDrawItem(GLX.getInstance(), item, slotIndex, xPos, yPos, getListWidth(), heightIn, mouseXIn, mouseYIn, partialTicks);
	}
