...
public interface World {
	...
	boolean rayTraceBlocks(Vector3<Double> start, Vector3<Double> end);
	 ...
	 */
	@ApiStatus.Internal
	<T extends TileEntity> T getTileEntityByReference(net.minecraft.tileentity.TileEntity reference);
