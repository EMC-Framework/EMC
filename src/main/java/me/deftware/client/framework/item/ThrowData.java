...
public class ThrowData {
    ...
    private final EntityEnderEye entity;
    public double x;
    public double z;
    public double posX;
    public double posZ;
    ...
    public ThrowData(EntityEnderEye entity, double posX, double posZ, double x, double z) {
        this.entity = entity;
        this.posX = posX;
        this.posZ = posZ;
        this.x = x;
    ...
    public boolean sameEntity(EntityEnderEye e) {
        return entity == e;
    }
