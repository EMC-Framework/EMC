...
public class ContainerHelper {
	...
	private static Container getCurrent() {
		Container handler = Objects.requireNonNull(Minecraft.getMinecraft().thePlayer).openContainer;
		if (handler != null && handler instanceof ContainerChest) {
			return handler;
		}
		return null;
	}
	...
	public static boolean isEmpty() {
		return getInventory().getFieldCount() == 0;
	}
