...
public enum ShaderTarget {
	...
	public void renderBuffer() {
		if (framebuffer != null && shader != null && enabled) {
			...
			// Draw buffer
			framebuffer.framebufferRenderExt(Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight, false);
			// Unbind shader
			shader.unbind();
		}
	}
	...
	public void init() {
		framebuffer = new Framebuffer(Minecraft.getMinecraft().getFramebuffer().framebufferWidth, Minecraft.getMinecraft().getFramebuffer().framebufferHeight, true);
	}
