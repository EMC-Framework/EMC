...
public class CPacketUseEntity extends PacketWrapper {
    ...
    public static CPacketUseEntity attack(Entity entity) {
        return new CPacketUseEntity(new PlayerInteractEntityC2SPacket(entity.getMinecraftEntity()));
    }

    public static CPacketUseEntity interact(Entity entity) {
        return new CPacketUseEntity(new PlayerInteractEntityC2SPacket(entity.getMinecraftEntity(), Hand.MAIN_HAND));
    }
