...
public class ColoredDynamicFont extends DynamicFont {
    ...
    public int generateString(String text, Color color) {
        if (color == Color.black) {
            // Assume its a shadow
            return super.generateString(EnumChatFormatting.getTextWithoutFormattingCodes(text), color);
        }
    ...
    public int getStringWidth(String text) {
        return super.getStringWidthNonScaled(EnumChatFormatting.getTextWithoutFormattingCodes(text));
    }
